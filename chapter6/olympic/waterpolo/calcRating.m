...
switch Opt.sexStr
    case 'M'
        title(['Prediction model; Waterpolo, Olympic Games 2024, Men' ])
    case 'W'
        title('Prediction model; Waterpolo, Olympic Games 2024, Women')
end
...
grid on;
set(gca,'FontName','arial','fontsize',12);
exportgraphics(gcf,['predictionModel_' Opt.sexStr '_' datestr(currentDate,'yyyymmdd') '.png']);
